...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "INPPARES" },
      { property: "og:title", content: "Canal de Denuncias Seguras INPPARES | SafeReport" },
      {
        property: "og:description",
        content: "Reporte de forma confidencial o anónima faltas éticas, acoso, discriminación o malas prácticas financieras en INPPARES. Disponible 24/7 en todo el Perú.",
      },
